...
const initialProducts = [
    ...
    { id: 7, name: 'Minimalist Smartwatch', category: 'electronics', price: 9999, oldPrice: 12999, rating: '⭐⭐⭐⭐⭐', image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=500&q=80', description: 'Advanced fitness tracking meets elegant design.' },
    ...
    { id: 25, name: 'Minimalist Desk Lamp', category: 'electronics', price: 1499, oldPrice: 2499, rating: '⭐⭐⭐⭐⭐', image: 'https://images.unsplash.com/photo-1517502884422-41eaead166d4?w=500&q=80', description: 'A sleek, modern desk lamp with adjustable brightness and color temperature.' },
    { id: 27, name: 'Aviator Sunglasses', category: 'accessories', price: 1899, oldPrice: 2799, rating: '⭐⭐⭐⭐⭐', image: 'https://images.unsplash.com/photo-1473496169904-658ba7c44d8a?w=500&q=80', description: 'Classic aviator design featuring polarized lenses and a lightweight metal frame.' },
    { id: 28, name: 'Cozy Knit Sweater', category: 'fashion', price: 2499, oldPrice: 3499, rating: '⭐⭐⭐⭐⭐', image: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=500&q=80', description: 'Stay warm and stylish with this incredibly soft, high-quality knit sweater.' },
    { id: 30, name: 'Leather Watch Band', category: 'accessories', price: 1199, oldPrice: 1599, rating: '⭐⭐⭐⭐⭐', image: 'https://images.unsplash.com/photo-1542496658-e33a6d0d50f6?w=500&q=80', description: 'Elevate your smartwatch with this premium genuine leather watch band.' }
];
